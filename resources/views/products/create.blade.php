   ...
   <div class = " flex justify-center">
                    <form method="POST" action="{{route('product.store')}}" class="bg-white rounded-md shadow-2xl p-5 user  lg:w-1/2 " enctype="multipart/form-data">
                      ...
                      <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                        <input class=" pl-2 w-1/2 outline-none border-none" type="text" name="name" placeholder="Nombre del Prodcuto" value ="{{ old('name') }}"/>
                      </div>
                      <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                        <input class=" pl-2 w-1/2 outline-none border-none" type="text" name="slug" placeholder="URL del Prodcuto"  />
                      </div>
                      <div class="flex items-center border-2 mb-12 py-2 px-3 rounded-2xl ">
                        <input class="pl-2  outline-none border-none "type="number" step="any" name="price"  placeholder="Precio" />
                      </div>
                      <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                            ...
                            <div class="row et-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" rows="4" name="description" placeholder="Descripcion" class="text-black"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row et-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="specification" rows="4" name="specification" placeholder="Especificaciones" class="text-black"></textarea>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <ul class="w-48 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <li class="w-full rounded-t-lg border-b border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="vue-checkbox" type="checkbox" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
