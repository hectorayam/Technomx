                        ...
                        <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                            ...
                            <tr>
                                <td align="left" height="70" style="height:70px;">
                                    <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" src="https://techno-mx.com/assets/images/techno.png" alt="" /></a>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <div style="line-height: 24px">
                                        Hola, {{$username}} tu pedio ya fue realizado el cual consta de 
                                    </div>
                                </td>
                            </tr>
                        </table>
    ...
    <tr>
        <td align="center">
            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                     ...
                     <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                         ...
                         <tbody>
                           @foreach(Cart::session($userID)->getContent() as $item)
                             ...
                             <tr class="bg-white dark:bg-gray-800">
                                 ...
                                 <td class="py-4 px-6">
                                  $ {{ number_format(Cart::session($userID)->get($item->id)->getPriceSum(),2) }}
                                 </td>
                             </tr>
                             @endforeach
                         </tbody>
                         <tfoot>
                             <tr class="font-semibold text-gray-900 dark:text-white">
                                 <th scope="row" class="py-4 px-6 text-base">Total</th>
                                 <td class="py-4 px-6">{{ \Cart::session($userID)->getTotalQuantity()}}</td>
                                 <td class="py-4 px-6"></td>
                                 <td class="py-4 px-6">$ {{number_format(Cart::session($userID)->getTotal(),2)}}</td>
                             </tr>
                         </tfoot>
                     </table>
                 </div>
                ...
                <tr>
                    <td aling="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <tr>
                                <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    ...
                                    <div style="line-height: 24px">
                                        ...
                                        Te estaremos mando mensaje en breve para definir detalles del envio
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                        ...
                                        Nuestro correo: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">support@techno-mx.com</a>
