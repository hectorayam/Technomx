...
<div class = " flex justify-center">
    <form method="post" action="{{route('subcategory.store')}}" class="bg-white rounded-md shadow-2xl p-5 user  lg:w-1/2 " enctype="multipart/form-data">
        @csrf
      <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
        <input class=" pl-2 w-1/2 outline-none border-none" type="text" name="name" placeholder="Nombre de la subcategoria" />
      </div>
      <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
