                ...
                <div class="col-md-12">
                    <div class="card bg-teal-300">
                        <div class="card-header   bg-techno">
                            ...
                            <p class="card-category text-black">Subcategorias </p>
                        </div>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6">
                            ...
                            {{-- <a href="#" class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="Examinar"><i class="material-icons">library_books</i></a> --}}
                               ...
                               <a href="{{route('subcategory.edit',$subcategory->id)}}" class="btn btn-warning " ata-toggle="tooltip" data-placement="bottom" title="Editar"><i class="  material-icons">edit</i></a>
                            
                            
                             
                             <form action="{{route('subcategory.delete',$subcategory->id)}}" method="POST" style="display: inline-block" onsubmit="return confirm('¿Seguro?')">
                               @csrf 
                               @method('DELETE')
